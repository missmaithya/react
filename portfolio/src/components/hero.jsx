  ...
  return (
    <section className="flex justify-around items-center p-10 space-x-10 lg:flex-row ssm:space-y-10 text-white">
      <div className="lg:w-1/3 ssm:w-fit">
        ...
        <h1 className="text-6xl"> Maithya Sharlet</h1>
        <hr />
        <p className="mt-10 text-slate-300 font-sans">A tech freelancer</p>
      </div>
      ...
      <div className="w-1/3 ssm:w-fit">
        ...
        <p className="text-slate-300">
          Let us build quality in programming and design with our services
        </p>
        ...
        <div className="flex mt-5 space-x-4 cursor-pointer">
            ...
            <FaXTwitter size={40} className="border-4 hover:border-indigo-800 rounded-full"/>
